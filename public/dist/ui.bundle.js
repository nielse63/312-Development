...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var _nprogress = __webpack_require__(/*! nprogress */ 617);
	
	var _nprogress2 = _interopRequireDefault(_nprogress);
	
	// core
	
	var _libUtils_core = __webpack_require__(/*! ./lib/utils/_core */ 639);
	
	var _libUtils_core2 = _interopRequireDefault(_libUtils_core);
	
	// modules
	
	var _libComponents_nav = __webpack_require__(/*! ./lib/components/_nav */ 630);
	
	var _libComponents_nav2 = _interopRequireDefault(_libComponents_nav);
	
	var _libComponents_banner = __webpack_require__(/*! ./lib/components/_banner */ 625);
	
	var _libComponents_banner2 = _interopRequireDefault(_libComponents_banner);
	
	// modules
	
	var _libModules_bodyClass = __webpack_require__(/*! ./lib/modules/_body-class */ 635);
	
	var _libModules_bodyClass2 = _interopRequireDefault(_libModules_bodyClass);
	
	var _libModules_form = __webpack_require__(/*! ./lib/modules/_form */ 636);
	
	var _libModules_form2 = _interopRequireDefault(_libModules_form);
	
	var _libVendorHamburger = __webpack_require__(/*! ./lib/vendor/hamburger */ 644);
	
	var _libVendorHamburger2 = _interopRequireDefault(_libVendorHamburger);
	
	var _libComponents_lazyload = __webpack_require__(/*! ./lib/components/_lazyload */ 628);
	
	var _libComponents_lazyload2 = _interopRequireDefault(_libComponents_lazyload);
	
	var _libComponents_links = __webpack_require__(/*! ./lib/components/_links */ 629);
	
	var _libComponents_links2 = _interopRequireDefault(_libComponents_links);
	
	var _libComponents_homepage = __webpack_require__(/*! ./lib/components/_homepage */ 627);
	
	var _libComponents_homepage2 = _interopRequireDefault(_libComponents_homepage);
	
	var _libComponents_workGrid = __webpack_require__(/*! ./lib/components/_work-grid */ 634);
	
	var _libComponents_workGrid2 = _interopRequireDefault(_libComponents_workGrid);
	
	var _libComponents_photos = __webpack_require__(/*! ./lib/components/_photos */ 631);
	
	var _libComponents_photos2 = _interopRequireDefault(_libComponents_photos);
	
	var _libComponents_services = __webpack_require__(/*! ./lib/components/_services */ 632);
	
	var _libComponents_services2 = _interopRequireDefault(_libComponents_services);
	
	var _libComponents_share = __webpack_require__(/*! ./lib/components/_share */ 633);
	
	var _libComponents_share2 = _interopRequireDefault(_libComponents_share);
	
	var _libComponents_footer = __webpack_require__(/*! ./lib/components/_footer */ 626);
	
	var _libComponents_footer2 = _interopRequireDefault(_libComponents_footer);
	
	// globals
	
	window._c = new _libUtils_core2['default']();var didLoad = false;
	var modules = [{
		preload: false,
		Cls: _libVendorHamburger2['default'],
		val: null
	}, {
		preload: false,
		Cls: _libComponents_banner2['default'],
		val: null
	}, {
		once: true,
		preload: true,
		Cls: _libComponents_nav2['default'],
		val: null
	}, {
		preload: false,
		Cls: _libComponents_homepage2['default'],
		val: null
	}, {
		preload: true,
		Cls: _libComponents_workGrid2['default'],
		val: null
	}, {
		preload: false,
		Cls: _libComponents_services2['default'],
		val: null
	}, {
		preload: false,
		Cls: _libComponents_photos2['default'],
		val: null
	}, {
		preload: true,
		Cls: _libComponents_links2['default'],
		val: null
	}, {
		preload: false,
		Cls: _libModules_form2['default'],
		val: null
	}, {
		preload: false,
		Cls: _libComponents_lazyload2['default'],
		val: null
	}, {
		preload: false,
		Cls: _libComponents_footer2['default'],
		val: null
	}, {
		preload: false,
		Cls: _libComponents_share2['default'],
		val: null
	}];
	var transitionEvent = _c.support.transition.end + '.app';
	var scenes = [];
	...
	function initModules() {
		var preload = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];
	...
	function preMount() {
		_libModules_bodyClass2['default'].exec();
		initModules(true);
	}
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "app.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
					...
					this.check = function(init) {
						...
						if (missing === 0 && func) {
							...
							if (global) {
								...
								if (!hasModule && "function" === "function" && __webpack_require__(/*! !webpack amd options */ 767)){ //AMD
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function( factory ) {
		if ( true ) {
			!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ 22)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
/***/ 625:
/*!**************************************************!*\
  !*** ./assets/scripts/lib/components/_banner.js ***!
  \**************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _scrollmagic = __webpack_require__(/*! scrollmagic */ 47);
	
	var _scrollmagic2 = _interopRequireDefault(_scrollmagic);
	
	var _gsap = __webpack_require__(/*! gsap */ 613);
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "_banner.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }

/***/ },

/***/ 626:
/*!**************************************************!*\
  !*** ./assets/scripts/lib/components/_footer.js ***!
  \**************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Footer = (function () {
		...
		_createClass(Footer, [{
			...
			value: function setPaths() {
				...
				var offsetBottom = offsetTop + this.$footer.outerHeight();
			...
			value: function createScene() {
				...
				}).setClassToggle(footer, 'inview').on('start', function () {
					this.remove();
				}).addTo(_c.controller);
			}
		}]);
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "_footer.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! jquery */ 22)))

/***/ },

/***/ 627:
/*!****************************************************!*\
  !*** ./assets/scripts/lib/components/_homepage.js ***!
  \****************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Homepage = (function () {
		...
		_createClass(Homepage, [{
			...
			value: function setScene() {
				var $trigger = _c.$('.article-title');
				var $container = $trigger.closest('.wrap');
	
				this.scene = new _scrollmagic2['default'].Scene({
					triggerElement: $trigger[0],
					triggerHook: 'onEnter'
				}).setClassToggle($container[0], 'loaded').on('start', function () {
					this.remove();
				}).addTo(_c.controller);
			}
		}]);
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "_homepage.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }

/***/ },

/***/ 628:
/*!****************************************************!*\
  !*** ./assets/scripts/lib/components/_lazyload.js ***!
  \****************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! whatwg-fetch */ 768);
		...
		_createClass(LazyLoad, [{
			...
			value: function loadAll() {
				...
				fetch(src).then(function (response) {
					...
					var _src = URL.createObjectURL(blob);
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "_lazyload.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }

/***/ },

/***/ 629:
/*!*************************************************!*\
  !*** ./assets/scripts/lib/components/_links.js ***!
  \*************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "_links.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }

/***/ },

/***/ 630:
/*!***********************************************!*\
  !*** ./assets/scripts/lib/components/_nav.js ***!
  \***********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Nav = (function () {
		...
		_createClass(Nav, [{
			key: 'setActiveLine',
			value: function setActiveLine($link) {
			...
			value: function initActiveLine() {
				...
				this.$items.each(function () {
					var $ele = $(this);
					$ele.off('.nav');
					$ele.on('click.nav', _this.onClick.bind(_this)).on('mouseenter.nav', _this.onMouseenter.bind(_this)).on('mouseleave.nav', _this.onMouseleave.bind(_this));
				});
			}
		}]);
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "_nav.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! jquery */ 22)))
...
/***/ 631:
/*!**************************************************!*\
  !*** ./assets/scripts/lib/components/_photos.js ***!
  \**************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Photos = (function () {
		...
		_createClass(Photos, [{
			...
			key: 'setScene',
			value: function setScene() {
				var trigger = this.$container[0];
	
				this.scene = new _scrollmagic2['default'].Scene({
					triggerElement: trigger
				}).setClassToggle(trigger, 'active').on('start', function () {
					this.remove();
				}).addTo(_c.controller);
			}
		}]);
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "_photos.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! jquery */ 22)))
...
/***/ 632:
/*!****************************************************!*\
  !*** ./assets/scripts/lib/components/_services.js ***!
  \****************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "_services.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! jquery */ 22)))
...
/***/ 633:
/*!*************************************************!*\
  !*** ./assets/scripts/lib/components/_share.js ***!
  \*************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Share = function Share() {
		...
		var SHARE = {
			...
			share: {
				...
				facebook: function facebook(btn) {
				...
				googleplus: function googleplus(btn) {
					SHARE.data.url = btn.attr('href') ? btn.attr('href') : btn.attr('data-url');
					if (!SHARE.data.url) {
				...
				linkedin: function linkedin(btn) {
					SHARE.data.url = btn.attr('href') ? btn.attr('href') : btn.attr('data-url');
					if (!SHARE.data.url) {
		...
		var selector = '[data-retweet], [data-share]';
		var checked = 0;
		var interval = setInterval(function () {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "_share.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }

/***/ },

/***/ 634:
/*!*****************************************************!*\
  !*** ./assets/scripts/lib/components/_work-grid.js ***!
  \*****************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _utils_colorbrew = __webpack_require__(/*! ../utils/_colorbrew */ 638);
	
	var _utils_colorbrew2 = _interopRequireDefault(_utils_colorbrew);
	
	var _tinycolor2 = __webpack_require__(/*! tinycolor2 */ 766);
	...
	var _vendorSplitText = __webpack_require__(/*! ../vendor/SplitText */ 643);
	
	var _vendorSplitText2 = _interopRequireDefault(_vendorSplitText);
	...
	var WorkGrid = (function () {
		...
		_createClass(WorkGrid, [{
			...
			key: 'setPreviewText',
			value: function setPreviewText() {
				this.$workBlocks.each(function () {
					var $preview = _c.$(this).find('.preview');
					var text = [];
	
					new _vendorSplitText2['default']($preview[0], {
						type: 'lines'
			...
			value: function getRandomColor() {
				var keys = Object.keys(_utils_colorbrew2['default']);
				var key = keys[Math.floor(Math.random() * keys.length)];
				var object = _utils_colorbrew2['default'][key];
				return object[Math.max.apply(null, Object.keys(object))];
			}
		}, {
			key: 'colorizeWorkBlocks',
			value: function colorizeWorkBlocks() {
				...
				this.$workBlocks.each(function () {
					...
					var tc = (0, _tinycolor22['default'])(color);
			...
			key: 'scrollWorkGrid',
			value: function scrollWorkGrid() {
				var _this = this;
	
				this.$workBlocks.each(function (i) {
					var trigger = this;
					var $block = _c.$(this);
					var $figure = $block.find('.work-block-figure');
					var diff = $block.outerHeight() - $figure.outerHeight();
					...
					})($block)).on('progress', (function (_i, _figure, _diff) {
						return function (e) {
							var y = _diff * e.progress * (_i % 2 === 0 ? -1 : 1);
							_figure.css({
								transform: 'translateY(' + y + 'px)'
							});
						};
					})(i, $figure, diff)).addTo(_c.controller);
	...
	exports['default'] = WorkGrid;
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "_work-grid.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! jquery */ 22)))
...
/***/ 635:
/*!***************************************************!*\
  !*** ./assets/scripts/lib/modules/_body-class.js ***!
  \***************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "_body-class.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }

/***/ },

/***/ 636:
/*!*********************************************!*\
  !*** ./assets/scripts/lib/modules/_form.js ***!
  \*********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! jquery-validation */ 615);
		...
		_createClass(Form, [{
			...
			value: function defineListeners() {
				...
				this.$inputs.on('focus', function () {
					...
					var isInvalid = !!!this.$inputs.toArray().find(function (input) {
			...
			key: 'setRequiredClass',
			value: function setRequiredClass() {
			...
			value: function initValidation() {
				...
				var validator = this.element.validate({
					focusInvalid: false,
					onkeyup: false,
					onfocusout: function onfocusout(input) {
					...
					showErrors: function showErrors(errorMap, errorList) {
						...
						for (var i = 0; i < errorList.length; i++) {
							...
							var $input = _c.$(errorList[i].element);
							...
							// set li classes
							$input.closest('li').removeClass('form-valid').addClass('form-error');
	
							// trigger input event
							$input.data('formerror', true).trigger('invalid');
						}
						...
						if ($target && $target.length) {
							...
							if (_top < screenTop || _top > screenTop + window.innerHeight) {
								var d = _top - screenTop;
								var duration = d < 400 ? 400 : d;
					...
					success: function success(label, input) {
						...
						if ($input.hasClass('error')) {
							$input.removeData('formerror').trigger('valid');
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "_form.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }

/***/ },

/***/ 637:
/*!**********************************************!*\
  !*** ./assets/scripts/lib/utils/_browser.js ***!
  \**********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Browser = (function () {
		...
		_createClass(Browser, [{
			...
			key: 'test',
			value: function test(rgx) {
				return rgx.test(this.userAgent);
			}
		}, {
			key: 'uamatches',
			value: function uamatches(key) {
				return this.userAgent.indexOf(key) > -1;
			}
		}, {
			key: 'version',
			value: function version(versionType, versionFull) {
				var type = versionType;
				var array = versionFull.split('.');
			...
			value: function detectBrowser() {
				...
				if (!this.test(/opera|webtv/) && (this.test(/msie\s([\d\w\.]+)/) || this.uamatches('trident'))) {
					...
					var versionTest = this.test(/opera(\s|\/)([\d\.]+)/) ? RegExp.$2 : '';
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "_browser.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }

/***/ },

/***/ 638:
/*!************************************************!*\
  !*** ./assets/scripts/lib/utils/_colorbrew.js ***!
  \************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "_colorbrew.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }

/***/ },

/***/ 639:
/*!*******************************************!*\
  !*** ./assets/scripts/lib/utils/_core.js ***!
  \*******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _utils = __webpack_require__(/*! ./_utils */ 642);
	
	var _utils2 = _interopRequireDefault(_utils);
	
	var _support = __webpack_require__(/*! ./_support */ 641);
	
	var _support2 = _interopRequireDefault(_support);
	
	var _browser = __webpack_require__(/*! ./_browser */ 637);
	
	var _browser2 = _interopRequireDefault(_browser);
	
	var _events = __webpack_require__(/*! ./_events */ 640);
	...
	var Clique = function Clique() {
		...
		this.browser = new _browser2['default']();
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "_core.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! jquery */ 22)))
...
/***/ 640:
/*!*********************************************!*\
  !*** ./assets/scripts/lib/utils/_events.js ***!
  \*********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Events = (function () {
			...
			this.events = {
				...
				scrollstart: {
					setup: function setup() {
						...
						var ns = 'scrolling.clique.events.' + uid;
					...
					teardown: function teardown() {
						var element = _c.$(this);
						var uid = element.data('clique.event.scrollstart.uid');
				...
				scrollend: {
					...
					setup: function setup(data) {
						...
						var timer = null;
						var handler = function handler(e, scrollData) {
							if (timer) {
					...
					teardown: function teardown() {
						var $element = _c.$(this);
						var uid = $element.data('clique.event.scrollend.uid');
				...
				resizestart: {
					setup: function setup() {
						...
						var ns = 'resize.clique.events.' + uid;
						var latency = _c.$.event.special.resizeend.latency + 150;
						var timer = undefined;
						var handler = function handler(e) {
							if (timer) {
								window.clearTimeout(timer);
					...
					teardown: function teardown() {
						var $element = _c.$(this);
						var uid = $element.data('clique.event.resizestart.uid');
				...
				resizeend: {
					...
					teardown: function teardown() {
						var $element = _c.$(this);
						var uid = $element.data('clique.event.resizeend.uid');
		...
		_createClass(Events, [{
			...
			value: function createEvents() {
				...
				Object.keys(this.events).forEach(function (k) {
					var v = _this.events[k];
					if (typeof v === 'object') {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "_events.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(/*! jquery */ 22)))
...
/***/ 641:
/*!**********************************************!*\
  !*** ./assets/scripts/lib/utils/_support.js ***!
  \**********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Support = function Support() {
		...
		this.touch = 'ontouchstart' in window || window.DocumentTouch && document instanceof window.DocumentTouch || window.navigator.msPointerEnabled && window.navigator.msMaxTouchPoints > 0 || window.navigator.pointerEnabled && window.navigator.maxTouchPoints > 0 || false;
		...
		this.animation = (function () {
			var animationEnd = (function () {
				...
				var keys = Object.keys(animEndEventNames);
				for (var i = 0; i < keys.length; i++) {
					var k = keys[i];
					if (element.style[k] !== undefined) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "_support.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }

/***/ },

/***/ 642:
/*!********************************************!*\
  !*** ./assets/scripts/lib/utils/_utils.js ***!
  \********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Utils = (function () {
		...
		_createClass(Utils, [{
			...
			key: 'prefixFor',
			value: function prefixFor(property) {
			...
			key: 'convertSize',
			value: function convertSize(int) {
				if (int > 1024 * 1024) {
			...
			key: 'makeSlug',
			value: function makeSlug(string) {
				...
				return path.replace(/\/|_/g, '-').toLowerCase().split('.')[0];
			}
		}, {
			key: 'openWindow',
			value: function openWindow(url, w, h) {
				var width = _c.utils.isUndefined(w) ? 600 : w;
				var height = _c.utils.isUndefined(h) ? 600 : h;
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "_utils.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }

/***/ },

/***/ 643:
/*!************************************************!*\
  !*** ./assets/scripts/lib/vendor/SplitText.js ***!
  \************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "SplitText.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
...
/***/ 644:
/*!************************************************!*\
  !*** ./assets/scripts/lib/vendor/hamburger.js ***!
  \************************************************/
/***/ function(module, exports, __webpack_require__) {
	  ...
	  */
		...
		var Hamburgers = {
			...
			clickHandle: function clickHandle(e) {
				...
				_c.$html.addClass('menu-open').removeClass('menu-closed');
				...
				function cb() {
					...
					_c.$html.addClass('menu-closed').removeClass('menu-open');
				}
	
				if (ele.hasClass('is-active')) {
					target.first().one(_c.support.transition.end, function () {
						_c.$html.one('click.clique.hamburger', cb);
					});
				}
			},
	
			headerAnimate: function headerAnimate() {
				var classes = ['slider', 'squeeze', 'arrow', 'arrowalt', 'spin', 'elastic', 'emphatic', 'collapse', 'vortex', 'stand', 'spring', '3dx', '3dy', 'boring'];
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/eriknielsen/Sites/312-latest.dev/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "hamburger.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
